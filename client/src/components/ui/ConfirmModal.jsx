  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white border border-[#F0F0F0] rounded-[32px] p-8 max-w-[360px] w-full shadow-[0_20px_40px_rgba(0,0,0,0.08)] animate-scale-in">
        <h2 className="text-2xl font-black text-[#1A1A1A] mb-2 tracking-tighter uppercase">Are you sure?</h2>
        <p className="text-[#888] mb-8 text-sm font-medium leading-relaxed">{confirm.message}</p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <button 
            onClick={hideConfirm}
            className="w-full py-3 text-[#BBB] hover:text-[#1A1A1A] hover:bg-gray-50 rounded-xl font-bold transition-all uppercase tracking-tighter text-[10px]"
          >
            Cancel
          </button>
        </div>

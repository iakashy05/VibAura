      ...
      <div className="space-y-8 md:space-y-16">
        {!query || query.trim() === '' ? (
          <div className="flex h-96 flex-col items-center justify-center text-text-muted space-y-4">
            <div className="w-16 h-16 rounded-full bg-vibaura-view-bg dark:bg-vibaura-bg-muted/30 flex items-center justify-center border border-black/5 dark:border-white/5 shadow-sm">
              <svg className="w-6 h-6 opacity-35 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {topResult && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
                ...
                <div className="lg:col-span-5 xl:col-span-4 space-y-3">
                  ...
                  <div className="bg-vibaura-surface p-5 rounded-[28px] border border-black/[0.03] dark:border-white/5 group relative overflow-hidden transition-all hover:bg-black/[0.01] dark:hover:bg-white/5">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="px-2.5 py-0.5 bg-vibaura-view-bg dark:bg-vibaura-bg-muted/40 rounded-full text-[8px] font-black uppercase tracking-wider text-[#999] dark:text-text-secondary">
                        {topResult.resultType}
                      </span>
                      <span className="text-[11px] font-bold text-[#888] dark:text-text-muted truncate">{topResult.subtitle}</span>
                    </div>
